...
5. At the end of each topic, add:
   ...
   - If available, add a line "🔗 [Visit Website](URL)" with a direct link to the product, model, paper, or announcement being discussed (NOT a link to the newsletter itself)
